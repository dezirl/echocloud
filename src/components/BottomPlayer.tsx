    ...
    <div className="h-[88px] border-t border-white/[0.07] bg-zinc-900/65 backdrop-blur-2xl px-6 relative z-40 select-none flex items-center justify-between">
      ...
      <div className="flex-1 max-w-xl mx-4 flex flex-col items-center">
        ...
        <div className="flex items-center gap-5">
          ...
          <button
            onClick={togglePlay}
            className="w-11 h-11 rounded-full bg-accent hover:brightness-90 text-white flex items-center justify-center shadow-[0_4px_16px_rgba(255,107,0,0.3)] scale-100 hover:scale-105 active:scale-95 cursor-pointer transition"
          >
            {isPlaying
              ? <Pause size={18} className="text-white" />
              : <Play size={18} className="fill-current text-white" style={{ transform: 'translateX(1px)' }} />
            }
          </button>
      ...
      <div className="flex items-center gap-3 w-[30%] justify-end shrink-0 select-none">
        ...
        <div className="flex items-center gap-2.5 max-w-[140px]">
          ...
          <div className="relative w-14 md:w-20 h-5 flex items-center cursor-pointer group">
