...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (activeTab === 'likes') {
      ...
      setContextQueue(homeSections.flatMap(s => s.tracks.filter((t: any) => t._sectionKind !== 'playlist').map((t: any) => t.id)));
    }
      ...
      <AnimatePresence>
        {updateCountdown !== null && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-[99] flex items-center gap-4 px-5 py-3.5 rounded-2xl border shadow-[0_8px_40px_rgba(0,0,0,0.7)] backdrop-blur-2xl"
            style={{ background: 'rgba(10,10,14,0.96)', borderColor: 'rgba(255,107,0,0.35)' }}
          >
